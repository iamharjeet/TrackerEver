...
public class TrackersActivity extends AppCompatActivity {
    ...
    private void getTrackUsers() {
        receiveRequestReference.child(userMobile).addValueEventListener(new ValueEventListener() {
            @Override
            ...
            public void onCancelled(@NonNull DatabaseError error) {
                Toast.makeText(TrackersActivity.this, error.getMessage(), Toast.LENGTH_SHORT).show();
            }
        });
    }
    ...
    private void setAdapter() {
        adapter = new TrackersAdapter(getApplicationContext(), list, new TrackersAdapter.Clicks() {
            ...
            public void OnClickStop(int position) {
                sendRequestReference.child(list.get(position).getMobile()).child(userMobile).setValue(null);
                receiveRequestReference.child(userMobile).child(list.get(position).getMobile()).setValue(null);
                ...
                NotificationStructure notificationData=new NotificationStructure(userMobile,"has Stop you to track him.",key);
